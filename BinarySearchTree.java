...
bst.insert(12);
bst.insert(16);
System.out.println("Path to 16: "+bst.path(16));
System.out.println("Path to 66: "+bst.path(1));
System.out.println("The number of leaves is "+bst.getNumberOfLeaves());
System.out.println(bst.inorderPredecessor(10));
bst.inorder(bst.root);
System.out.println();
System.out.println("testing left and right sub trees");
System.out.println();
ArrayList<Integer> a,b;
a=bst.rightSubTree(10);
System.out.println();
b=bst.leftSubTree(10);
